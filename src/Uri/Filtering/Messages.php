...
class Messages
{
    ...
    {
        return "Error in the 'orderby' clause. Type '$resourceTypeName' does not have a property named
         '$propertyName'.";
    }
    ...
    {
        return "Error processing request stream. The property name '$propertyName' specified for
         type '$resourceTypeName' is not valid. (Check the resource set of the navigation property '$propertyName'
          is visible)";
    }
    ...
    {
        return "The response requires that version $requiredVersion of the protocol be used, but the MaxProtocolVersion
         of the data service is set to $configuredVersion.";
    }
    ...
    public static function requestDescriptionUnSupportedVersion(
        ...
        return "The version value $requestedVersion in the header $requestHeaderName is not supported,
    ...
    {
        return 'If-Match or If-None-Match headers cannot be specified if the target type does not have etag properties
         defined.';
    }
    ...
    {
        return "If-Match or If-None-Match HTTP headers cannot be specified since the URI '$uri' refers to a collection
         of resources or has a \$count or \$link segment or has a \$expand as one of the query parameters.";
    }
    ...
    public static function hostMalFormedBaseUriInConfig($notEndWithSvcOrHasQuery = false)
    {
        if ($notEndWithSvcOrHasQuery) {
            return 'Malformed base service uri in the configuration file (should end with .svc, there should not be
             query or fragment in the base service uri)';
        }
